...
<g:each status="category_id" var="i" in="${ ['All','Music','ArtsCalture','Sports','Networking','Charities','Free'] }">
	...
	<div id="categoryButton" class="btn-group">
		...
		<button data-location='${category_id}' class=" ${statusOfButton} btn btn-info btn_custom btn_${category_id} ">
			<g:if test="${i == 'ArtsCalture'}" >
				<g:set var="categoryName" value= "Arts&Calture" />
			</g:if>
			<g:else >
